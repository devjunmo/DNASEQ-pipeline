...
ref_dir = r'/data_244/refGenome/refGenome/b37/'

ref_genome_path = ref_dir + 'human_g1k_v37.fasta'

PON_path = ref_dir + r'somatic_src/'
germ_src_path = ref_dir + r'somatic_src/'
sec_src_path = ref_dir + r'somatic_src/'
...
for i in range(len(input_lst)):
    ...
    try:
        ...
        sp.call(f'echo "python ./run_mutect2.py -n {target_normal_name} -t {t_name} -I {input_dir} -R {ref_genome_path} -L {interval_path} -y {seq_type} \
